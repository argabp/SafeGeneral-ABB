...
{
    public class ApprovalAkseptasiRevCommand : IRequest<(string, List<string>)>
    {
    ...
    public class ApprovalAkseptasiRevCommandHandler : IRequestHandler<ApprovalAkseptasiRevCommand, (string, List<string>)>
    {
        ...
        public ApprovalAkseptasiRevCommandHandler(IDbConnectionFactory connectionFactory,
        ...
        public async Task<(string, List<string>)> Handle(ApprovalAkseptasiRevCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                message = (await _connectionFactory.QueryProc<string>("sp_ApprovalPengajuanAksRev",
                    new
                    {
