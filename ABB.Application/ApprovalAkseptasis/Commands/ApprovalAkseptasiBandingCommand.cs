...
{
    public class ApprovalAkseptasiBandingCommand : IRequest<(string, List<string>)>
    {
    ...
    public class ApprovalAkseptasiBandingCommandHandler : IRequestHandler<ApprovalAkseptasiBandingCommand, (string, List<string>)>
    {
        ...
        public ApprovalAkseptasiBandingCommandHandler(IDbConnectionFactory connectionFactory,
        ...
        public async Task<(string, List<string>)> Handle(ApprovalAkseptasiBandingCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                message = (await _connectionFactory.QueryProc<string>("sp_ApprovalPengajuanAksBand",
                    new
                    {
