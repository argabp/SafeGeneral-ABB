...
{
    public class ApprovalAkseptasiCommand : IRequest<(string, List<string>)>
    {
    ...
    public class ApprovalAkseptasiCommandHandler : IRequestHandler<ApprovalAkseptasiCommand, (string, List<string>)>
    {
        ...
        public ApprovalAkseptasiCommandHandler(IDbConnectionFactory connectionFactory, IDbConnection dbConnection,
        ...
        public async Task<(string, List<string>)> Handle(ApprovalAkseptasiCommand request, CancellationToken cancellationToken)
        {
