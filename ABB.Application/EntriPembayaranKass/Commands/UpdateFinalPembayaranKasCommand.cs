...
{
    public class UpdateFinalPembayaranKasCommand : IRequest
    {
    ...
    public class UpdateFinalPembayaranKasCommandHandler : IRequestHandler<UpdateFinalPembayaranKasCommand>
    {
        private readonly IDbContextPstNota _context;

        public UpdateFinalPembayaranKasCommandHandler(IDbContextPstNota context)
        {
            _context = context;
        }

        public async Task<Unit> Handle(UpdateFinalPembayaranKasCommand request, CancellationToken cancellationToken)
        {
