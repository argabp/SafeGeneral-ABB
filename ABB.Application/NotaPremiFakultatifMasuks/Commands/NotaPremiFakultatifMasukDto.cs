...
{
    public class NotaPremiFakultatifMasukDto : IMapFrom<SaveEntriNotaCommand>
    {
        public NotaPremiFakultatifMasukDto()
        {
        ...
        {
            profile.CreateMap<NotaPremiFakultatifMasukDto, SaveEntriNotaCommand>();
            profile.CreateMap<NotaPremiFakultatifMasukDto, SaveEntriNotaCancelCommand>();
        }
    }
}