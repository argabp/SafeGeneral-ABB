...
{
    public class UpdatePembayaranBankLihatCommand : IRequest
    {
    ...
    public class UpdatePembayaranBankLihatCommandHandler : IRequestHandler<UpdatePembayaranBankLihatCommand>
    {
        ...
        public UpdatePembayaranBankLihatCommandHandler(IDbContextPstNota context)
        {
            _context = context;
        }

        public async Task<Unit> Handle(UpdatePembayaranBankLihatCommand request, CancellationToken cancellationToken)
        {
