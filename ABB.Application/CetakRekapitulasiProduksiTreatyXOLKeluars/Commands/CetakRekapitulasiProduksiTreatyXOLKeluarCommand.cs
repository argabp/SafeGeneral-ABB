...
namespace ABB.Application.CetakRekapitulasiProduksiTreatyXOLKeluars.Commands
{
    public class CetakRekapitulasiProduksiTreatyXOLKeluarCommand : IRequest<string>
    {
    ...
    public class
        CetakRekapitulasiProduksiTreatyXOLKeluarCommandHandler : IRequestHandler<CetakRekapitulasiProduksiTreatyXOLKeluarCommand
        , string>
    {
        private readonly IDbConnectionPst _connectionPst;
        private readonly IHostEnvironment _environment;

        public CetakRekapitulasiProduksiTreatyXOLKeluarCommandHandler(IDbConnectionPst connectionPst,
        ...
        public async Task<string> Handle(CetakRekapitulasiProduksiTreatyXOLKeluarCommand request,
            CancellationToken cancellationToken)
        {
            ...
            {
                case "1":
                    spName = "spr_ri07r_01xol";
                    break;
            }

            var datas = (await _connectionPst.QueryProc<CetakRekapitulasiProduksiTreatyXOLKeluarModel>(spName,
                new
                {
            ...
            string reportPath = Path.Combine(_environment.ContentRootPath, "Modules", "Reports", "Templates",
                "RekapitulasiProduksiTreatyXOLKeluar.html");
