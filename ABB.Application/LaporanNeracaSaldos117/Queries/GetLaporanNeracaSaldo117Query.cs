...
namespace ABB.Application.LaporanNeracaSaldos117.Queries
{
    public class LaporanNeracaSaldo117Response
    {
        public string HtmlString { get; set; }
        public List<SpLaporanNeracaSaldo117Result> RawData { get; set; } 
    }

    public class GetLaporanNeracaSaldo117Query : IRequest<LaporanNeracaSaldo117Response> 
    {
    ...
    public class GetLaporanNeracaSaldo117QueryHandler : IRequestHandler<GetLaporanNeracaSaldo117Query, LaporanNeracaSaldo117Response>
    {
        private readonly IDbContextPstNota _context;
        private readonly IHostEnvironment _environment;

        public GetLaporanNeracaSaldo117QueryHandler(IDbContextPstNota context, IHostEnvironment environment) 
        {
            _context = context;
            _environment = environment; 
        }

        public async Task<LaporanNeracaSaldo117Response> Handle(GetLaporanNeracaSaldo117Query request, CancellationToken cancellationToken)
        {
            ...
            var dataLaporan = await _context.SpLaporanNeracaSaldo117Results
                .FromSqlRaw("EXEC spr_akt_03_117 {0}", tgl)
                .AsNoTracking()
            ...
            string reportPath = Path.Combine(_environment.ContentRootPath, "Modules", "Reports", "Templates", "LaporanNeracaSaldo117.html");
            if (!File.Exists(reportPath)) throw new FileNotFoundException("Template LaporanNeracaSaldo117.html tidak ditemukan!");
            ...
            return new LaporanNeracaSaldo117Response
            {
