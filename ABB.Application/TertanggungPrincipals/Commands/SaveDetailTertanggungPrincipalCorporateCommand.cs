...
{
    public class SaveDetailTertanggungPrincipalCorporateCommand : IRequest, IMapFrom<DetailRekanan>
    {
        ...
        {
            profile.CreateMap<SaveDetailTertanggungPrincipalCorporateCommand, DetailRekanan>();
        }
    }

    public class SaveDetailTertanggungPrincipalCorporateCommandHandler : IRequestHandler<SaveDetailTertanggungPrincipalCorporateCommand>
    {
        private readonly IDbContextFactory _contextFactory;
        private readonly IMapper _mapper;
        private readonly IDbConnectionFactory _connectionFactory;
        private readonly ILogger<SaveDetailTertanggungPrincipalCorporateCommandHandler> _logger;

        public SaveDetailTertanggungPrincipalCorporateCommandHandler(IDbContextFactory contextFactory, IMapper mapper, IDbConnectionFactory connectionFactory,
            ILogger<SaveDetailTertanggungPrincipalCorporateCommandHandler> logger)
        {
        ...
        public async Task<Unit> Handle(SaveDetailTertanggungPrincipalCorporateCommand request, CancellationToken cancellationToken)
        {
