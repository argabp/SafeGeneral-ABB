...
{
    public class SaveDetailTertanggungPrincipalCorporateFullCommand : IRequest, IMapFrom<DetailRekanan>
    {
        ...
        {
            profile.CreateMap<SaveDetailTertanggungPrincipalCorporateFullCommand, DetailRekanan>();
        }
    }

    public class SaveDetailTertanggungPrincipalCorporateFullCommandHandler : IRequestHandler<SaveDetailTertanggungPrincipalCorporateFullCommand>
    {
        private readonly IDbContextFactory _contextFactory;
        private readonly IMapper _mapper;
        private readonly IDbConnectionFactory _connectionFactory;
        private readonly ILogger<SaveDetailTertanggungPrincipalCorporateFullCommandHandler> _logger;

        public SaveDetailTertanggungPrincipalCorporateFullCommandHandler(IDbContextFactory contextFactory, IMapper mapper, IDbConnectionFactory connectionFactory,
            ILogger<SaveDetailTertanggungPrincipalCorporateFullCommandHandler> logger)
        {
        ...
        public async Task<Unit> Handle(SaveDetailTertanggungPrincipalCorporateFullCommand request, CancellationToken cancellationToken)
        {
            try
            {
