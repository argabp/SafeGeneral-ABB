...
{
    public class EntriPenyelesaianPiutangTempDto : IMapFrom<EntriPenyelesaianPiutangTemp>
    {
        ...
        {
            profile.CreateMap<EntriPenyelesaianPiutangTemp, EntriPenyelesaianPiutangTempDto>();
