...
{
    public class SaveKontrakTreatyMasukXOLCommand : IRequest, IMapFrom<KontrakTreatyMasuk>
    {
        ...
        {
            profile.CreateMap<SaveKontrakTreatyMasukXOLCommand, KontrakTreatyMasuk>();
        }
    }

    public class SaveKontrakTreatyMasukXOLCommandHandler : IRequestHandler<SaveKontrakTreatyMasukXOLCommand>
    {
        private readonly IDbContextPst _contextPst;
        private readonly IDbConnectionPst _connectionPst;
        private readonly ILogger<SaveKontrakTreatyMasukXOLCommandHandler> _logger;
        private readonly IMapper _mapper;

        public SaveKontrakTreatyMasukXOLCommandHandler(IDbContextPst contextPst, IDbConnectionPst connectionPst,
            ILogger<SaveKontrakTreatyMasukXOLCommandHandler> logger, IMapper mapper)
        {;
        ...
        public async Task<Unit> Handle(SaveKontrakTreatyMasukXOLCommand request, CancellationToken cancellationToken)
        {
