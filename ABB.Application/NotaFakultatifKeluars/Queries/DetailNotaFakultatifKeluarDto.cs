...
{
    public class DetailNotaFakultatifKeluarDto : IMapFrom<DetailNotaFakultatifKeluar>
    {
        ...
        {
            profile.CreateMap<DetailNotaFakultatifKeluarDto, DetailNotaFakultatifKeluar>();
        }
    }
}