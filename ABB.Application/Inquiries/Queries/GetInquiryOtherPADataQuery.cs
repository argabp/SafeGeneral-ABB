...
{
    public class GetInquiryOtherPADataQuery : IRequest<List<string>>
    {
    ...
    public class GetInquiryOtherPADataQueryHandler : IRequestHandler<GetInquiryOtherPADataQuery, List<string>>
    {
        private readonly IDbConnectionFactory _connectionFactory;

        public GetInquiryOtherPADataQueryHandler(IDbConnectionFactory connectionFactory)
        {
            _connectionFactory = connectionFactory;
        }

        public async Task<List<string>> Handle(GetInquiryOtherPADataQuery request, CancellationToken cancellationToken)
        {
