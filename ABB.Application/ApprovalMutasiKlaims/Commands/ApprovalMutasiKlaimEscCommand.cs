...
{
    public class ApprovalMutasiKlaimEscCommand : IRequest<(string, List<string>)>
    {
    ...
    public class ApprovalMutasiKlaimEscCommandHandler : IRequestHandler<ApprovalMutasiKlaimEscCommand, (string, List<string>)>
    {
