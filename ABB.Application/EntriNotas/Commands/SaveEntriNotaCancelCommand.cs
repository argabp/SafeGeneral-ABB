...
{
    public class SaveEntriNotaCancelCommand : IRequest
    {
    ...
    public class SaveEntriNotaCancelCommandHandler : IRequestHandler<SaveEntriNotaCancelCommand>
    {
        private readonly IDbContextFactory _contextFactory;
        private readonly ILogger<SaveEntriNotaCancelCommandHandler> _logger;
        private readonly IMapper _mapper;

        public SaveEntriNotaCancelCommandHandler(IDbContextFactory contextFactory,
            ILogger<SaveEntriNotaCancelCommandHandler> logger, IMapper mapper)
        {;
        ...
        public async Task<Unit> Handle(SaveEntriNotaCancelCommand request, CancellationToken cancellationToken)
        {
            try
            {
