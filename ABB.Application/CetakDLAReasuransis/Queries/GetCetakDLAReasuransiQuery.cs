...
{
    public class GetCetakDLAReasuransiQuery : IRequest<string>
    {
    ...
    public class GetCetakDLAReasuransiQueryHandler : IRequestHandler<GetCetakDLAReasuransiQuery, string>
    {
        private readonly IDbConnectionPst _connectionPst;
        private readonly IHostEnvironment _environment;
        private readonly ILogger<GetCetakDLAReasuransiQueryHandler> _logger;

        public GetCetakDLAReasuransiQueryHandler(IDbConnectionPst connectionPst, 
            IHostEnvironment environment, ILogger<GetCetakDLAReasuransiQueryHandler> logger)
        {
        ...
        public async Task<string> Handle(GetCetakDLAReasuransiQuery request, CancellationToken cancellationToken)
        {
