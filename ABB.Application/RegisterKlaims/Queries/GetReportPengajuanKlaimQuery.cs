...
{
    public class GetReportPengajuanKlaimQuery : IRequest<(string, string)>
    {
    ...
    public class GetReportPengajuanKlaimQueryHandler : IRequestHandler<GetReportPengajuanKlaimQuery, (string, string)>
    {
        ...
        public GetReportPengajuanKlaimQueryHandler(IDbConnectionFactory connectionFactory, 
        ...
        public async Task<(string, string)> Handle(GetReportPengajuanKlaimQuery request, CancellationToken cancellationToken)
        {
            _connectionFactory.CreateDbConnection(request.DatabaseName);

            var datas = (await _connectionFactory.QueryProc<ReportPengajuanKlaimDto>("sp_ResumeKlaim", 
                new
                {
                    input_str = $"{request.kd_cb.Trim()},{request.kd_cob.Trim()},{request.kd_scob.Trim()}," +
                                $"{request.kd_thn},{request.no_kl.Trim()}"
                })).ToList();
            
            string reportPath = Path.Combine( _environment.ContentRootPath, "Modules", "Reports", "Templates", "PengajuanKlaim.html" );
            ...
            var resultTemplate = templateProfileResult.Render( new
            {
                ...
                data.st_pas, pst_share_bgu = ReportHelper.ConvertToReportFormat(data.pst_share_bgu),
                ...
                data.analisa_klaim, signature1, signature2, signature3, data.jabatan_dibuat, data.jabatan_diperiksa,
                data.jabatan_disetujui, data.nm_dibuat, data.nm_diperiksa, data.nm_disetujui,
                tgl_dibuat, tgl_diperiksa, tgl_disetujui, data.nomor_berkas, keterangan_resiko,
                nilai_ttl_ptg_share = ReportHelper.ConvertToReportFormat(data.nilai_ttl_ptg_share), data.nm_tol,
            ...
            string secondReportPath = Path.Combine( _environment.ContentRootPath, "Modules", "Reports", "Templates", "KeteranganPengajuanKlaim.html" );
            
            string secondTemplateReportHtml = await File.ReadAllTextAsync( secondReportPath );

            var nomor_berkas = string.Empty;

            if (secondDatas.Any())
            {
                nomor_berkas = secondDatas[0].nomor_berkas;
            }
            ...
            {
                nomor_berkas, detail = detail.ToString() 
            } );

            return (resultTemplate, secondResultTemplate);
        }

        private string GenerateKeteranganDokumen(ReportPengajuanKlaimDto reportPengajuanKlaimDto)
        {
            StringBuilder sb = new StringBuilder();

            var nm_dokumen1 = string.IsNullOrWhiteSpace(reportPengajuanKlaimDto.nm_dokumen1) ? string.Empty : reportPengajuanKlaimDto.nm_dokumen1;
            var st_dokumen1 = reportPengajuanKlaimDto.st_dokumen1 != null && reportPengajuanKlaimDto.st_dokumen1.Value ? "checked" : string.Empty;
            var nm_dokumen2 = string.IsNullOrWhiteSpace(reportPengajuanKlaimDto.nm_dokumen2) ? string.Empty : reportPengajuanKlaimDto.nm_dokumen2;
            var st_dokumen2 = reportPengajuanKlaimDto.st_dokumen2 != null && reportPengajuanKlaimDto.st_dokumen2.Value ? "checked" : string.Empty;
            var nm_dokumen3 = string.IsNullOrWhiteSpace(reportPengajuanKlaimDto.nm_dokumen3) ? string.Empty : reportPengajuanKlaimDto.nm_dokumen3;
            var st_dokumen3 = reportPengajuanKlaimDto.st_dokumen3 != null && reportPengajuanKlaimDto.st_dokumen3.Value ? "checked" : string.Empty;
            var nm_dokumen4 = string.IsNullOrWhiteSpace(reportPengajuanKlaimDto.nm_dokumen4) ? string.Empty : reportPengajuanKlaimDto.nm_dokumen4;
            var st_dokumen4 = reportPengajuanKlaimDto.st_dokumen4 != null && reportPengajuanKlaimDto.st_dokumen4.Value ? "checked" : string.Empty;
            var nm_dokumen5 = string.IsNullOrWhiteSpace(reportPengajuanKlaimDto.nm_dokumen5) ? string.Empty : reportPengajuanKlaimDto.nm_dokumen5;
            var st_dokumen5 = reportPengajuanKlaimDto.st_dokumen5 != null && reportPengajuanKlaimDto.st_dokumen5.Value ? "checked" : string.Empty;
            var nm_dokumen6 = string.IsNullOrWhiteSpace(reportPengajuanKlaimDto.nm_dokumen6) ? string.Empty : reportPengajuanKlaimDto.nm_dokumen6;
            var st_dokumen6 = reportPengajuanKlaimDto.st_dokumen6 != null && reportPengajuanKlaimDto.st_dokumen6.Value ? "checked" : string.Empty;
            var nm_dokumen7 = string.IsNullOrWhiteSpace(reportPengajuanKlaimDto.nm_dokumen7) ? string.Empty : reportPengajuanKlaimDto.nm_dokumen7;
            var st_dokumen7 = reportPengajuanKlaimDto.st_dokumen7 != null && reportPengajuanKlaimDto.st_dokumen7.Value ? "checked" : string.Empty;
            var nm_dokumen8 = string.IsNullOrWhiteSpace(reportPengajuanKlaimDto.nm_dokumen8) ? string.Empty : reportPengajuanKlaimDto.nm_dokumen8;
            var st_dokumen8 = reportPengajuanKlaimDto.st_dokumen8 != null && reportPengajuanKlaimDto.st_dokumen8.Value ? "checked" : string.Empty;
            var nm_dokumen9 = string.IsNullOrWhiteSpace(reportPengajuanKlaimDto.nm_dokumen9) ? string.Empty : reportPengajuanKlaimDto.nm_dokumen9;
            var st_dokumen9 = reportPengajuanKlaimDto.st_dokumen9 != null && reportPengajuanKlaimDto.st_dokumen9.Value ? "checked" : string.Empty;
            var nm_dokumen10 = string.IsNullOrWhiteSpace(reportPengajuanKlaimDto.nm_dokumen10) ? string.Empty : reportPengajuanKlaimDto.nm_dokumen10;
            var st_dokumen10 = reportPengajuanKlaimDto.st_dokumen10 != null && reportPengajuanKlaimDto.st_dokumen10.Value ? "checked" : string.Empty;
