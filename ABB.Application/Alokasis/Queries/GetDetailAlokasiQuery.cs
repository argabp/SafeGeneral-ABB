...
{
    public class GetDetailAlokasiQuery : IRequest<DetailAlokasiDto>
    {
    ...
    public class GetDetailAlokasiQueryHandler : IRequestHandler<GetDetailAlokasiQuery, DetailAlokasiDto>
    {
        private readonly IDbContextFactory _contextFactory;
        private readonly IMapper _mapper;

        public GetDetailAlokasiQueryHandler(IDbContextFactory contextFactory, IMapper mapper)
        {
            _contextFactory = contextFactory;
            _mapper = mapper;
        }

        public async Task<DetailAlokasiDto> Handle(GetDetailAlokasiQuery request, CancellationToken cancellationToken)
        {
            ...
            return _mapper.Map<DetailAlokasiDto>(entity);
        }
    }
}