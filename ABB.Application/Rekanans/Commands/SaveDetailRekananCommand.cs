...
{
    public class SaveDetailRekananCommand : IRequest, IMapFrom<DetailRekanan>
    {
        ...
        {
            profile.CreateMap<SaveDetailRekananCommand, DetailRekanan>();
        }
    }

    public class SaveDetailRekananCommandHandler : IRequestHandler<SaveDetailRekananCommand>
    {
        private readonly IDbContextFactory _contextFactory;
        private readonly IMapper _mapper;
        private readonly ILogger<SaveDetailRekananCommandHandler> _logger;

        public SaveDetailRekananCommandHandler(IDbContextFactory contextFactory, IMapper mapper,
            ILogger<SaveDetailRekananCommandHandler> logger)
        {
        ...
        public async Task<Unit> Handle(SaveDetailRekananCommand request, CancellationToken cancellationToken)
        {
            try
            {
