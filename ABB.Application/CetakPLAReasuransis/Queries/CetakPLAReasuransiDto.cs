...
{
    public class CetakPLAReasuransiDto
    {
        ...
        public string nm_jns_sor_03 { get; set; }

        public decimal? nilai_jns_sor_03 { get; set; }
        public string nm_jns_sor_04 { get; set; }

        public decimal? nilai_jns_sor_04 { get; set; }
        public string nm_jns_sor_05 { get; set; }

        public decimal? nilai_jns_sor_05 { get; set; }
        ...
        public string nm_sor_pas_01 { get; set; }

        public decimal? nilai_sor_pas_01 { get; set; }

        public string nm_sor_pas_02 { get; set; }

        public decimal? nilai_sor_pas_02 { get; set; }
        public string nm_sor_pas_03 { get; set; }

        public decimal? nilai_sor_pas_03 { get; set; }
        public string nm_sor_pas_04 { get; set; }

        public decimal? nilai_sor_pas_04 { get; set; }
        public string nm_sor_pas_05 { get; set; }

        public decimal? nilai_sor_pas_05 { get; set; }

        public decimal? pst_sor_pas_01 { get; set; }

        public decimal? pst_sor_pas_02 { get; set; }

        public decimal? pst_sor_pas_03 { get; set; }

        public decimal? pst_sor_pas_04 { get; set; }

        public decimal? pst_sor_pas_05 { get; set; }
