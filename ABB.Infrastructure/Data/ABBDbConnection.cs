...
using IDbConnection = ABB.Application.Common.Interfaces.IDbConnection;

namespace ABB.Infrastructure.Data
{
    public class ABBDbConnection : IDbConnection, IDisposable
    {
        public ABBDbConnection(IConfiguration configuration)
        {
            var connectionString = configuration.GetConnectionString("ABBConnection");
