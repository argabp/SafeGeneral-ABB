...
{
    public class AkseptasiPranotaMap : IEntityTypeConfiguration<AkseptasiPranota>
    {
        public void Configure(EntityTypeBuilder<AkseptasiPranota> builder)
        {
            builder.ToTable("uw02a", "dbo");
            builder.HasKey(k => new { k.kd_cb, k.kd_cob, k.kd_scob, k.kd_thn, k.no_aks, k.no_updt, k.kd_mtu });
