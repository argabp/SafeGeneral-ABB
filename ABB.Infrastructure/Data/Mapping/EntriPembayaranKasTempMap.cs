...
{
    public class EntriPembayaranKasTempMap : IEntityTypeConfiguration<EntriPembayaranKasTemp>
    {
        public void Configure(EntityTypeBuilder<EntriPembayaranKasTemp> builder)
        {
            builder.ToTable("abb_pembayaran_kas_temp");
