...
{
    public class AkseptasiResikoMap : IEntityTypeConfiguration<AkseptasiResiko>
    {
        public void Configure(EntityTypeBuilder<AkseptasiResiko> builder)
        {
            builder.ToTable("uw04a", "dbo");
