...
{
    public class InquiryResikoMap : IEntityTypeConfiguration<InquiryResiko>
    {
        public void Configure(EntityTypeBuilder<InquiryResiko> builder)
        {
            builder.ToTable("uw04e", "dbo");
