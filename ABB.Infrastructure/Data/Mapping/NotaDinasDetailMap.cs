...
{
    public class NotaDinasDetailMap : IEntityTypeConfiguration<NotaDinasDetail>
    {
        public void Configure(EntityTypeBuilder<NotaDinasDetail> builder)
        {
            builder.ToTable("TR_NotaDinasDetail", "dbo");
