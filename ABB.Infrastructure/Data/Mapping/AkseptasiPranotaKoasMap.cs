...
{
    public class AkseptasiPranotaKoasMap : IEntityTypeConfiguration<AkseptasiPranotaKoas>
    {
        public void Configure(EntityTypeBuilder<AkseptasiPranotaKoas> builder)
        {
            builder.ToTable("uw03a", "dbo");
            builder.HasKey(k => new { k.kd_cb, k.kd_cob, k.kd_scob, k.kd_thn, 
                k.no_aks, k.no_updt, k.kd_mtu, k.kd_grp_pas, k.kd_rk_pas });
