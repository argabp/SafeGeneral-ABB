...
{
    public class EntriPembayaranBankTempMap : IEntityTypeConfiguration<EntriPembayaranBankTemp>
    {
        public void Configure(EntityTypeBuilder<EntriPembayaranBankTemp> builder)
        {
            builder.ToTable("abb_pembayaran_bank_temp");
            ...
            builder.Property(t => t.NilaiKurs).HasColumnName("nilai_kurs").HasPrecision(18,2);
