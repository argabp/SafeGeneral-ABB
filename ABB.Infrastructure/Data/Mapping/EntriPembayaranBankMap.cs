...
{
    public class EntriPembayaranBankMap : IEntityTypeConfiguration<EntriPembayaranBank>
    {
        public void Configure(EntityTypeBuilder<EntriPembayaranBank> builder)
        {
            builder.ToTable("abb_pembayaran_bank");
