...
using ABB.Application.ProsesTutupBulan.Queries;
using ABB.Application.ProsesTutupBulan.Commands;
using ABB.Application.ProsesTutupBulan.Dtos; // Pastikan namespace DTO benar


namespace ABB.Web.Modules.ProsesTutupBulan
{
    public class ProsesTutupBulanController : AuthorizedBaseController
    {
       ...
       [HttpPost]
        public async Task<IActionResult> GetDaftarPeriode([DataSourceRequest] DataSourceRequest request)
        {
            ...
            var data = await Mediator.Send(new GetDaftarPeriodeQuery());
        ...
        [HttpPost]
        public async Task<IActionResult> ProcessClosing([FromBody] List<ProsesTutupBulanCommand> commands) 
        {
            ...
            try
            {
                ...
                return Json(new { success = true, message = "Proses Tutup Bulan Berhasil!" });
            }
