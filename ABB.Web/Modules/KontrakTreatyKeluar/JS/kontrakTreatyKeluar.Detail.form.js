$(document).ready(async function () {
    btnSaveDetailKontrakTreatyKeluar_Click();
});

function btnSaveDetailKontrakTreatyKeluar_Click() {
    $('#btn-save-detailKontrakTreatyKeluar').click(function () {
        showProgress('#KontrakTreatyKeluarWindow');
        setTimeout(function () {
            saveDetailKontrakTreatyKeluar()
        }, 500);
    });
}

function saveDetailKontrakTreatyKeluar(){
    ...
    var id = kd_cb + kd_jns_sor + kd_tty_pps + kd_grp_pas + kd_rk_pas;
    ...
    OnDetailKontrakTreatyKeluarDataBound({ sender: grid });
