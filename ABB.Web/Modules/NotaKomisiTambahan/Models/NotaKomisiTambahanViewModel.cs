...
namespace ABB.Web.Modules.NotaKomisiTambahan.Models
{
    public class NotaKomisiTambahanViewModel : IMapFrom<SaveNotaKomisiTambahanCommand>
    {
        ...
        {
            profile.CreateMap<NotaKomisiTambahanViewModel, SaveNotaKomisiTambahanCommand>();
            profile.CreateMap<NotaKomisiTambahanDto, NotaKomisiTambahanViewModel>();
        }
    }
}