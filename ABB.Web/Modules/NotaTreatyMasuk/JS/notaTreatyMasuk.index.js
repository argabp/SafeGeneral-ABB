...
function onViewNotaTreatyMasuk(e) {
    e.preventDefault();
    var dataItem = this.dataItem($(e.currentTarget).closest("tr"));
    console.log('dataItem', dataItem);
    openNotaTreatyMasukWindow(`/NotaTreatyMasuk/View?kd_cb=${dataItem.kd_cb}&kd_thn=${dataItem.kd_thn}&kd_bln=${dataItem.kd_bln}&kd_jns_sor=${dataItem.kd_jns_sor}&kd_tty_msk=${dataItem.kd_tty_msk}&kd_mtu=${dataItem.kd_mtu}&no_tr=${dataItem.no_tr}`, 'View');
}
...
function OnNotaTreatyMasukDataBound(e){
    var grid = this;
