...
namespace ABB.Web.Modules.NotaTreatyMasuk.Models
{
    public class NotaTreatyMasukViewModel : IMapFrom<SaveNotaTreatyMasukCommand>
    {
        ...
        {
            profile.CreateMap<NotaTreatyMasukViewModel, SaveNotaTreatyMasukCommand>();
            profile.CreateMap<Domain.Entities.TransaksiTreatyMasuk, NotaTreatyMasukViewModel>();
        }
    }
}