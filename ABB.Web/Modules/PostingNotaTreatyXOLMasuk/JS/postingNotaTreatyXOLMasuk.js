...
function searchKeyword_OnKeyUp() {
    $('#SearchKeyword').keyup(function () {
        refreshGrid("#PostingNotaTreatyXOLMasukGrid");
    });
}

function searchFilterPostingNotaTreatyXOLMasuk(e) {
...
function onChangeGridPostingNotaTreatyXOLMasuk(e) {
    var grid = e.sender;
...
function postingNotaTreatyXOLMasuk(){
    showConfirmation('Confirmation', `Are you sure you want to posting?`,
        function () {
            showProgressOnGrid('#PostingNotaTreatyXOLMasukGrid');

            ajaxPost("/PostingNotaTreatyXOLMasuk/Posting", JSON.stringify(selectedRowsData),
                function (response) {
                    ...
                    var grid = $("#PostingNotaTreatyXOLMasukGrid").data("kendoGrid");
                    if (grid) {
                        grid.clearSelection();
                    }
                    selectedRowsData = [];
                    refreshGrid('#PostingNotaTreatyXOLMasukGrid');
                    closeProgressOnGrid('#PostingNotaTreatyXOLMasukGrid');
                },
            );
        }
    );
