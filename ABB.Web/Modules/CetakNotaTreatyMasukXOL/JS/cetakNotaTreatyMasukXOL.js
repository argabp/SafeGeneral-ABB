...
function searchKeyword_OnKeyUp() {
    $('#SearchKeyword').keyup(function () {
        refreshGrid("#CetakNotaTreatyMasukXOLGrid");
    });
}

function viewReport(e){
    showProgressOnGrid('#CetakNotaTreatyMasukXOLGrid');
    ...
    ajaxPost("/CetakNotaTreatyMasukXOL/GenerateReport", JSON.stringify(form),
        function (response) {
            ...
            closeProgressOnGrid('#CetakNotaTreatyMasukXOLGrid');
        }, 
    );
}