$(document).ready(function () {
    btnApprovalMutasiKlaimProcess();
});

function btnApprovalMutasiKlaimProcess(){
    $('#btn-approvalMutasiKlaim-process').click(function () {
        ...
        setTimeout(function () {
            approvalMutasiKlaimProcess();
        }, 500);
    });
}

function approvalMutasiKlaimProcess(){
