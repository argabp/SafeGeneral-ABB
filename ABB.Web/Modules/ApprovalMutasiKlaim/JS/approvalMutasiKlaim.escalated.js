$(document).ready(function () {
    btnApprovalMutasiKlaimEscalated();
});

function btnApprovalMutasiKlaimEscalated(){
    $('#btn-approvalMutasiKlaim-escalated').click(function () {
        ...
        setTimeout(function () {
            approvalMutasiKlaimEscalated();
        }, 500);
    });
}

function approvalMutasiKlaimEscalated(){
    ...
    ajaxUpload("/ApprovalMutasiKlaim/ApprovalMutasiKlaimEsc", form, function (response) {
