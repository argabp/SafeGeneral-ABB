...
{
    public class AkseptasiResikoViewModel : IMapFrom<AkseptasiResikoDto>
    {
        ...
        {
            profile.CreateMap<AkseptasiResikoDto, AkseptasiResikoViewModel>();
            profile.CreateMap<AkseptasiResikoViewModel, SaveAkseptasiResikoCommand>();
        }
    }
}