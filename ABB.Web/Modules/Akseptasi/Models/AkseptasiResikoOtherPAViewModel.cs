...
{
    public class AkseptasiResikoOtherPAViewModel : IMapFrom<AkseptasiOtherPADto>
    {
        ...
        {
            profile.CreateMap<AkseptasiOtherPADto, AkseptasiResikoOtherPAViewModel>();
            profile.CreateMap<AkseptasiResikoOtherPAViewModel, SaveAkseptasiOtherPACommand>();
        }
    }
}