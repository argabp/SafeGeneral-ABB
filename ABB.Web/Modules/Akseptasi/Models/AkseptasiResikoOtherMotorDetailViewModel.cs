...
{
    public class AkseptasiResikoOtherMotorDetailViewModel : IMapFrom<AkseptasiOtherMotorDetailDto>
    {
        ...
        {
            profile.CreateMap<AkseptasiOtherMotorDetailDto, AkseptasiResikoOtherMotorDetailViewModel>();
            profile.CreateMap<AkseptasiResikoOtherMotorDetailViewModel, SaveAkseptasiOtherMotorDetailCommand>();
        }
    }
}