...
{
    public class AkseptasiPranotaViewModel : IMapFrom<AkseptasiPranotaDto>
    {
        ...
        {
            profile.CreateMap<AkseptasiPranotaDto, AkseptasiPranotaViewModel>();
            profile.CreateMap<AkseptasiPranotaViewModel, SaveAkseptasiPranotaCommand>();
        }
    }
}