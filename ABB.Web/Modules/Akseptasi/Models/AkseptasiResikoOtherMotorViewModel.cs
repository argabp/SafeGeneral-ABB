...
namespace ABB.Web.Modules.Akseptasi.Models
{
    public class AkseptasiResikoOtherMotorViewModel : IMapFrom<AkseptasiOtherMotorDto>
    {
        ...
        {
            profile.CreateMap<AkseptasiOtherMotorDto, AkseptasiResikoOtherMotorViewModel>();
            profile.CreateMap<AkseptasiResikoOtherMotorViewModel, SaveAkseptasiOtherMotorCommand>();
        }
    }
}