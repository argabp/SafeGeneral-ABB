...
{
    public class SaveRekananViewModel : IMapFrom<SaveRekananCommand>
    {
        ...
        {
            profile.CreateMap<SaveRekananViewModel, SaveRekananCommand>();
            profile.CreateMap<Domain.Entities.Rekanan, SaveRekananViewModel>();
            profile.CreateMap<SaveRekananViewModel, SaveTertanggungPrincipalCommand>();
        }
    }
}