...
{
    public class InquiryResikoOtherMotorDetailViewModel : IMapFrom<InquiryOtherMotorDetailDto>
    {
        ...
        {
            profile.CreateMap<InquiryOtherMotorDetailDto, InquiryResikoOtherMotorDetailViewModel>();
        }
    }
}