...
{
    public class InquiryResikoOtherBondingViewModel : IMapFrom<InquiryOtherBondingDto>
    {
        ...
        {
            profile.CreateMap<InquiryOtherBondingDto, InquiryResikoOtherBondingViewModel>();
        }
    }
}