...
{
    public class MutasiKlaimAlokasiModel : IMapFrom<DeleteMutasiKlaimAlokasiCommand>
    {
        ...
        {
            profile.CreateMap<MutasiKlaimAlokasiModel, DeleteMutasiKlaimAlokasiCommand>();
        }
    }
}