...
using ABB.Web.Modules.LaporanBulananFakultatif.Models;
using DinkToPdf;
using Microsoft.AspNetCore.Http;
using Microsoft.AspNetCore.Mvc;

namespace ABB.Web.Modules.LaporanBulananFakultatif
{
    public class LaporanBulananFakultatifController : AuthorizedBaseController
    {
        private readonly IReportGeneratorService _reportGeneratorService;

        public LaporanBulananFakultatifController(IReportGeneratorService reportGeneratorService)
        {
        ...
        public async Task<JsonResult> GetJenisLaporan()
        {
            ...
            {
                new DropdownOptionDto() { Text = "Fakultatif Masuk", Value = "B2" },
                new DropdownOptionDto() { Text = "Fakultatif Keluar", Value = "C2" }
            };
        ...
        [HttpPost]
        public async Task<ActionResult> GenerateReport([FromBody] LaporanBulananFakultatifViewModel model)
        {
            try
            {
                var command = Mapper.Map<LaporanBulananFakultatifCommand>(model);
                ...
                _reportGeneratorService.GenerateReport("LaporanBulananFakultatif.pdf", reportTemplate,
