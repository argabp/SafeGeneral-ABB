...
{
    public class PolisIndukViewModel : IMapFrom<PolisIndukDto>
    {
        ...
        {
            profile.CreateMap<PolisIndukDto, PolisIndukViewModel>();
            profile.CreateMap<PolisIndukViewModel, AddPolisIndukCommand>();
            profile.CreateMap<PolisIndukViewModel, EditPolisIndukCommand>();
        }
    }
}