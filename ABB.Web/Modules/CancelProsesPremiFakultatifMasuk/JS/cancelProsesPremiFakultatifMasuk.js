...
function btnCancel_OnClick(e) {
    ...
    showConfirmation('Confirmation', `Apakah anda akan melanjutkan Cancel?`,
        function () {
            showProgressOnGrid('#ReopenPolisGrid');
            setTimeout(function () { cancelProsesPremiFakultatifMasuk(dataItem); }, 500);
        }
    );
}

function cancelProsesPremiFakultatifMasuk(dataItem){
    ...
    ajaxPost(`/CancelProsesPremiFakultatifMasuk/Cancel`, data,  function (response) {
