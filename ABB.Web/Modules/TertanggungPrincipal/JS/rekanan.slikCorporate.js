function onSaveDetailSlikCorporate(){
    showConfirmation('Confirmation', `Are you sure you want to save?`,
        function () {
            var form = getFormData($('#DetailSlikCorporateForm'));
            ...
            ajaxPost("/TertanggungPrincipal/SaveDetailSlikCorporate", JSON.stringify(form),
                function (response) {
