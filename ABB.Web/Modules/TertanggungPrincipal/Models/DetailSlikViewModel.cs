...
namespace ABB.Web.Modules.TertanggungPrincipal.Models
{
    public class DetailSlikViewModel : IMapFrom<SaveDetailSlikCorporateCommand>
    {
        ...
        {
            profile.CreateMap<DetailSlik, DetailSlikViewModel>();
            profile.CreateMap<DetailSlikViewModel, SaveDetailSlikRetailCommand>();
            profile.CreateMap<DetailSlikViewModel, SaveDetailSlikCorporateCommand>();
        }
    }
}