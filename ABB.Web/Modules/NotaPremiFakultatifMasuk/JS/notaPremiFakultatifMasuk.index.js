...
function onEditEntriNota(e) {
    ...
    openEntriNotaWindow(`/NotaPremiFakultatifMasuk/Edit?kd_cb=${dataItem.kd_cb}&jns_tr=${dataItem.jns_tr}&jns_nt_msk=${dataItem.jns_nt_msk}&kd_thn=${dataItem.kd_thn}&kd_bln=${dataItem.kd_bln}&no_nt_msk=${dataItem.no_nt_msk}&jns_nt_kel=${dataItem.jns_nt_kel}&no_nt_kel=${dataItem.no_nt_kel}`, 'Edit Nota Tertanggung');
}
...
function onViewEntriNota(e) {
    ...
    var dataItem = this.dataItem($(e.currentTarget).closest("tr"));
    console.log('dataItem', dataItem);
    openEntriNotaWindow(`/NotaPremiFakultatifMasuk/View?kd_cb=${dataItem.kd_cb}&jns_tr=${dataItem.jns_tr}&jns_nt_msk=${dataItem.jns_nt_msk}&kd_thn=${dataItem.kd_thn}&kd_bln=${dataItem.kd_bln}&no_nt_msk=${dataItem.no_nt_msk}&jns_nt_kel=${dataItem.jns_nt_kel}&no_nt_kel=${dataItem.no_nt_kel}`, 'View Nota Tertanggung');
}
...
function onNotaTertanggungDetailPstAngChange(data) {
    ...
    ajaxGet(`/NotaPremiFakultatifMasuk/GenerateNilaiAng?pst_ang=${data.sender.value()}&nilai_nt=${$("#nilai_nt").val()}&nilai_ppn=${$("#nilai_ppn").val()}&nilai_pph=${$("#nilai_pph").val()}`, (returnValue) => {
...
function OnKodeRkTTJChange(e){
    ajaxGet(`/NotaPremiFakultatifMasuk/GenerateEntriNotaData?kd_rk=${e.sender.value()}&kd_cb=${$("#kd_cb").val()}&kd_grp_rk=${$("#kd_grp_ttj").val()}`, (returnValue) => {
