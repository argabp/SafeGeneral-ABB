$(document).ready(function () {
    btnApprovalAkseptasiBanding();
});

function btnApprovalAkseptasiBanding(){
    $('#btn-approvalAkseptasi-banding').click(function () {
        ...
        setTimeout(function () {
            approvalAkseptasiBanding();
        }, 500);
    });
}

function approvalAkseptasiBanding(){
    ...
    ajaxUpload("/ApprovalAkseptasi/ApprovalAkseptasiBanding", form, function (response) {
