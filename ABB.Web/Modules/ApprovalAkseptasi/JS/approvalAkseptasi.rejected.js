$(document).ready(function () {
    btnApprovalAkseptasiRejected();
});

function btnApprovalAkseptasiRejected(){
    $('#btn-approvalAkseptasi-rejected').click(function () {
        ...
        setTimeout(function () {
            approvalAkseptasiRejected();
        }, 500);
    });
}

function approvalAkseptasiRejected(){
