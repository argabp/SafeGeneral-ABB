...
{
    public class DetailNotaFakultatifKeluarViewModel : IMapFrom<DetailNotaFakultatifKeluarDto>
    {
        ...
        {
            profile.CreateMap<DetailNotaFakultatifKeluarViewModel, DetailNotaFakultatifKeluarDto>();
        }
    }
}