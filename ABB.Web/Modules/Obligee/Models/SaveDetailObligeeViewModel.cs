...
{
    public class SaveDetailObligeeViewModel : IMapFrom<SaveObligeeCommand>
    {
        ...
        {
            profile.CreateMap<SaveDetailObligeeViewModel, SaveDetailObligeeCommand>();
            profile.CreateMap<DetailObligee, SaveDetailObligeeViewModel>();
        }
    }
}