...
{
    public class SaveObligeeViewModel : IMapFrom<SaveObligeeCommand>
    {
        ...
        {
            profile.CreateMap<SaveObligeeViewModel, SaveObligeeCommand>();
            profile.CreateMap<Domain.Entities.Obligee, SaveObligeeViewModel>();
        }
    }
}