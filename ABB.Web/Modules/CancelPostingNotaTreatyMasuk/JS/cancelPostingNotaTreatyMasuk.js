...
function searchKeyword_OnKeyUp() {
    $('#SearchKeyword').keyup(function () {
        refreshGrid("#CancelPostingNotaTreatyMasukGrid");
    });
}

function searchFilterCancelPostingNotaTreatyMasuk(e) {
...
function onChangeGridCancelPostingNotaTreatyMasuk(e) {
    var grid = e.sender;
...
function cancelPostingNotaTreatyMasuk(){
    showConfirmation('Confirmation', `Are you sure you want to cancel?`,
        function () {
            showProgressOnGrid('#CancelPostingNotaTreatyMasukGrid');

            ajaxPost("/CancelPostingNotaTreatyMasuk/Cancel", JSON.stringify(selectedRowsData),
                function (response) {
                    ...
                    var grid = $("#CancelPostingNotaTreatyMasukGrid").data("kendoGrid");
                    if (grid) {
                        grid.clearSelection();
                    }
                    selectedRowsData = [];
                    refreshGrid('#CancelPostingNotaTreatyMasukGrid');
                    closeProgressOnGrid('#CancelPostingNotaTreatyMasukGrid');
                },
            );
        }
    );
