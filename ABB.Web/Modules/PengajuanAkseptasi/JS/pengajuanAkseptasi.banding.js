$(document).ready(function () {
    btnPengajuanAkseptasiBanding();
});

function btnPengajuanAkseptasiBanding(){
    $('#btn-pengajuanAkseptasi-banding').click(function () {

        if($("#keteranganBanding").val().trim() === ""){
        ...
        setTimeout(function () {
            pengajuanAkseptasiBanding();
        }, 500);
    });
}

function pengajuanAkseptasiBanding(){
    ...
    form.append("kd_status", 9);
    form.append("tgl_status", Date());
    form.append("keterangan", $("#keteranganBanding").val());
    ...
    ajaxUpload("/PengajuanAkseptasi/ApprovalAkseptasiBanding", form, function (response) {
