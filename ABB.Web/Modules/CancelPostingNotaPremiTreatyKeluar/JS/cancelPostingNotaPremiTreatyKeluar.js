...
function searchKeyword_OnKeyUp() {
    $('#SearchKeyword').keyup(function () {
        refreshGrid("#CancelPostingNotaPremiTreatyKeluarGrid");
    });
}

function searchFilterCancelPostingNotaPremiTreatyKeluar(e) {
...
function onChangeGridCancelPostingNotaPremiTreatyKeluar(e) {
    var grid = e.sender;
...
function cancelPostingNotaPremiTreatyKeluar(){
    showConfirmation('Confirmation', `Are you sure you want to cancel?`,
        function () {
            showProgressOnGrid('#CancelPostingNotaPremiTreatyKeluarGrid');

            ajaxPost("/CancelPostingNotaPremiTreatyKeluar/Cancel", JSON.stringify(selectedRowsData),
                function (response) {
                    ...
                    var grid = $("#CancelPostingNotaPremiTreatyKeluarGrid").data("kendoGrid");
                    if (grid) {
                        grid.clearSelection();
                    }
                    selectedRowsData = [];
                    refreshGrid('#CancelPostingNotaPremiTreatyKeluarGrid');
                    closeProgressOnGrid('#CancelPostingNotaPremiTreatyKeluarGrid');
                },
            );
        }
    );
