...
namespace ABB.Web.Modules.NotaPremiXOLKeluar.Models
{
    public class NotaPremiXOLKeluarViewModel : IMapFrom<SaveNotaPremiXOLKeluarCommand>
    {
        ...
        {
            profile.CreateMap<NotaPremiXOLKeluarViewModel, SaveNotaPremiXOLKeluarCommand>();
            profile.CreateMap<Domain.Entities.NotaKomisiTambahan, NotaPremiXOLKeluarViewModel>();
        }
    }
}