...
namespace ABB.Web.Modules.NotaKlaimReasuransi.Models
{
    public class NotaKlaimReasuransiViewModel : IMapFrom<SaveNotaKlaimReasuransiCommand>
    {
        ...
        {
            profile.CreateMap<NotaKlaimReasuransiViewModel, SaveNotaKlaimReasuransiCommand>();
            profile.CreateMap<Domain.Entities.NotaKlaimReasuransi, NotaKlaimReasuransiViewModel>();
        }
    }
}