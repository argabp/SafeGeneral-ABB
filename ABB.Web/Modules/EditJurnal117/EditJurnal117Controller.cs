...
using ABB.Application.EditJurnals117.Commands;
...
namespace ABB.Web.Modules.EditJurnal117
{
    public class EditJurnal117Controller : AuthorizedBaseController
    {
        ...
        [HttpPost]
        public async Task<IActionResult> GetInquiryData([DataSourceRequest] DataSourceRequest request, GetInquiryEditJurnal117Query query)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                return Json(new List<InquiryJurnal117Dto>().ToDataSourceResult(request));
            }
        }
        ...
        public async Task<IActionResult> GetDetailJurnal(string noBukti)
        {
            try
            {
                ...
                var query = new GetDetailEditJurnal117Query 
                { 
        ...
        [HttpPost]
        public async Task<IActionResult> SaveEditJurnal([FromBody] UpdateJurnal117Command command)
        {
            try
            {
