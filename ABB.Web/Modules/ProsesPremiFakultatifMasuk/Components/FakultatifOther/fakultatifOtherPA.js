...
function btnSaveAkseptasiResikoOther_Click() {
    $('#btn-save-akseptasiResikoOtherPA').click(function () {
        showProgress('#AkseptasiWindow');
        setTimeout(function () {
            saveAkseptasiResikoOther('/ProsesPremiFakultatifMasuk/SaveAkseptasiOtherPA')
        }, 500);
    });
}
...
function OnNilaiHargaPtgChange(e){
    ...
    ajaxGet(`/ProsesPremiFakultatifMasuk/GenerateDataOther?no_pol_ttg=${$("#no_pol_ttg").val()}&kd_jns_kr=${$("#kd_jns_kr").val()}&kd_grp_kr=${$("#kd_grp_kr").val()}&jk_wkt=${$("#jk_wkt").val()}&usia_deb=${$("#usia_deb").val()}&nilai_harga_ptg=${nilai_harga_ptg}&flag_std=${$("#flag_std").val()}&pst_rate_std=${$("#pst_rate_std").val()}&flag_bjr=${$("#flag_bjr").val()}&pst_rate_bjr=${$("#pst_rate_bjr").val()}&flag_gb=${$("#flag_gb").val()}&pst_rate_gb=${$("#pst_rate_gb").val()}&flag_tl=${$("#flag_tl").val()}&pst_rate_tl=${$("#pst_rate_tl").val()}`, (returnValue) => {
...
function OnFlagStdChange(e){
    ajaxGet(`/ProsesPremiFakultatifMasuk/GenerateOtherPAPremi?stn_rate=${$("#stn_rate_std").val()}&kd_grp_kr=${$("#kd_grp_kr").val()}&flag=${e.sender._cascadedValue}&nilai_harga_ptg=${$("#nilai_harga_ptg").val()}&pst_rate=${$("#pst_rate_std").val()}&no=1`, (returnValue) => {
...
function OnFlagBjrChange(e){
    ajaxGet(`/ProsesPremiFakultatifMasuk/GenerateOtherPAPremi?stn_rate=${$("#stn_rate_bjr").val()}&kd_grp_kr=${$("#kd_grp_kr").val()}&flag=${e.sender._cascadedValue}&nilai_harga_ptg=${$("#nilai_harga_ptg").val()}&pst_rate=${$("#pst_rate_bjr").val()}&no=2`, (returnValue) => {
...
function OnFlagGBChange(e){
    ajaxGet(`/ProsesPremiFakultatifMasuk/GenerateOtherPAPremi?stn_rate=${$("#stn_rate_gb").val()}&kd_grp_kr=${$("#kd_grp_kr").val()}&flag=${e.sender._cascadedValue}&nilai_harga_ptg=${$("#nilai_harga_ptg").val()}&pst_rate=${$("#pst_rate_gb").val()}&no=3`, (returnValue) => {
...
function OnFlagTLChange(e){
    ajaxGet(`/ProsesPremiFakultatifMasuk/GenerateOtherPAPremi?stn_rate=${$("#stn_rate_tl").val()}&kd_grp_kr=${$("#kd_grp_kr").val()}&flag=${e.sender._cascadedValue}&nilai_harga_ptg=${$("#nilai_harga_ptg").val()}&pst_rate=${$("#pst_rate_tl").val()}&no=4`, (returnValue) => {
...
function OnPstRateStdChange(e){
    ajaxGet(`/ProsesPremiFakultatifMasuk/GenerateOtherPAPremi?stn_rate=${$("#stn_rate_std").val()}&kd_grp_kr=${$("#kd_grp_kr").val()}&flag=${$("#flag_std").val()}&nilai_harga_ptg=${$("#nilai_harga_ptg").val()}&pst_rate=${e.sender.value()}&no=1`, (returnValue) => {
        $("#nilai_prm_std").getKendoNumericTextBox().value(returnValue.split(",")[1]);
        $("#nilai_prm_std").getKendoNumericTextBox().trigger("change");
    });
}
...
function OnPstRateBjrChange(e){
    ajaxGet(`/ProsesPremiFakultatifMasuk/GenerateOtherPAPremi?stn_rate=${$("#stn_rate_bjr").val()}&kd_grp_kr=${$("#kd_grp_kr").val()}&flag=${$("#flag_bjr").val()}&nilai_harga_ptg=${$("#nilai_harga_ptg").val()}&pst_rate=${e.sender.value()}&no=1`, (returnValue) => {
        $("#nilai_prm_bjr").getKendoNumericTextBox().value(returnValue.split(",")[1]);
        $("#nilai_prm_bjr").getKendoNumericTextBox().trigger("change");
    });
}
...
function OnPstRateGBChange(e){
    ajaxGet(`/ProsesPremiFakultatifMasuk/GenerateOtherPAPremi?stn_rate=${$("#stn_rate_gb").val()}&kd_grp_kr=${$("#kd_grp_kr").val()}&flag=${$("#flag_gb").val()}&nilai_harga_ptg=${$("#nilai_harga_ptg").val()}&pst_rate=${e.sender.value()}&no=1`, (returnValue) => {
        $("#nilai_prm_gb").getKendoNumericTextBox().value(returnValue.split(",")[1]);
        $("#nilai_prm_gb").getKendoNumericTextBox().trigger("change");
    });
}
...
function OnPstRateTLChange(e){
    ajaxGet(`/ProsesPremiFakultatifMasuk/GenerateOtherPAPremi?stn_rate=${$("#stn_rate_tl").val()}&kd_grp_kr=${$("#kd_grp_kr").val()}&flag=${$("#flag_tl").val()}&nilai_harga_ptg=${$("#nilai_harga_ptg").val()}&pst_rate=${e.sender.value()}&no=1`, (returnValue) => {
        $("#nilai_prm_tl").getKendoNumericTextBox().value(returnValue.split(",")[1]);
        $("#nilai_prm_tl").getKendoNumericTextBox().trigger("change");
    });
}
...
function OnNilaiPtgPhkChange(e){
    ...
    ajaxGet(`/ProsesPremiFakultatifMasuk/GeneratePrmPhk?nilai_ptg_phk=${nilai_ptg_phk}&pst_rate_phk=${$("#pst_rate_phk").val()}&stn_rate_std=${$("#stn_rate_std").val()}`, (returnValue) => {
...
function OnPstRatePhkChange(e){
    ajaxGet(`/ProsesPremiFakultatifMasuk/GeneratePrmPhk?nilai_ptg_phk=${$("#nilai_ptg_hh").val()}&pst_rate_phk=${e.sender.value()}&stn_rate_std=${$("#stn_rate_std").val()}`, (returnValue) => {
        $("#nilai_prm_phk").getKendoNumericTextBox().value(returnValue.split(",")[1]);
        $("#nilai_prm_phk").getKendoNumericTextBox().trigger("change");
    });
}
...
function OnTanggalPKChange(e){
    ajaxGet(`/ProsesPremiFakultatifMasuk/GenerateOtherPAData?jk_wkt=${$("#jk_wkt").val()}&tgl_lahir=${$("#tgl_lahir").val()}&tgl_real=${e.sender.value().toLocaleDateString()}&kd_cb=${$("#kd_cb").val()}&kd_jns_kr=${$("#kd_jns_kr").val()}&kd_grp_kr=${$("#kd_grp_kr").val()}`, (returnValue) => {
...
function OnJkWktChange(e){
    ajaxGet(`/ProsesPremiFakultatifMasuk/GenerateOtherPAData?jk_wkt=${e.sender.value()}&tgl_lahir=${$("#tgl_lahir").val()}&tgl_real=${$("#tgl_real").val()}&kd_cb=${$("#kd_cb").val()}&kd_jns_kr=${$("#kd_jns_kr").val()}&kd_grp_kr=${$("#kd_grp_kr").val()}`, (returnValue) => {
        $("#resiko_other_pa_tgl_mul_ptg").getKendoDatePicker().value(returnValue[2].split(",")[1]);
        $("#resiko_other_pa_tgl_akh_ptg").getKendoDatePicker().value(returnValue[1].split(",")[1]);
        $("#usia_deb").getKendoNumericTextBox().value(returnValue[3].split(",")[1]);
        $("#other_pa_no_endt").val(returnValue[0].split(",")[1]);
