...
function deleteAkseptasiResikoOtherMotor() {
    ...
    ajaxPost(`/ProsesPremiFakultatifMasuk/DeleteOtherMotor`, JSON.stringify(data), function (response) {
        if (response.Result) {
...
function btnSaveAkseptasiResikoOther_Click() {
    $('#btn-save-akseptasiResikoOther').click(function () {
        showProgress('#AkseptasiWindow');
        setTimeout(function () {
            saveAkseptasiResikoOther('/ProsesPremiFakultatifMasuk/SaveAkseptasiOtherMotor')
        }, 500);
    });
}
...
function OnJumlahTempatDudukChange(e){
    ...
    ajaxGet(`/ProsesPremiFakultatifMasuk/GetJumlahPAPenumpang?jml_tmpt_ddk=${value}`, (returnValue) => {
...
function OnNilaiCascoChange(e){
    var value = e.sender.value();
    ajaxGet(`/ProsesPremiFakultatifMasuk/GeneratePstRatePrm?kd_jns_kend=${$("#kd_jns_kend").val()}&kd_wilayah=${$("#kd_wilayah").val()}&kd_jns_ptg=${$("#kd_jns_ptg").val()}&nilai_casco=${value}`, (returnValue) => {
...
function OnPstRatePrmChange(e){
    var value = e.sender.value();
    ajaxGet(`/ProsesPremiFakultatifMasuk/GenerateNilaiPrmCasco?kd_guna=${$("#kd_guna").val()}&nilai_casco=${$("#nilai_casco").val()}&pst_rate_prm=${value}&stn_rate_prm=${$("#stn_rate_prm").val()}&nilai_tjh=${$("#nilai_tjh").val()}`, (returnValue) => {
        $("#nilai_prm_casco").getKendoNumericTextBox().value(returnValue.split(",")[1]);
    });
}

function OnHuruHaraChange(e){
    ajaxGet(`/ProsesPremiFakultatifMasuk/GeneratePstRateHH?kd_jns_kend=${$("#kd_jns_kend").val()}&kd_wilayah=${$("#kd_wilayah").val()}&kd_jns_ptg=${$("#kd_jns_ptg").val()}&nilai_casco=${$("#nilai_casco").val()}&flag_hh=${!e.checked}`, (returnValue) => {
...
function OnPstRateHHChange(e){
    var value = e.sender.value();
    ajaxGet(`/ProsesPremiFakultatifMasuk/GenerateNilaiPrmHH?nilai_casco=${$("#nilai_casco").val()}&pst_rate_hh=${value}&stn_rate_hh=${$("#stn_rate_hh").val()}`, (returnValue) => {
        $("#nilai_prm_hh").getKendoNumericTextBox().value(returnValue.split(",")[1]);
    });
}

function OnAOGChange(e){
    ajaxGet(`/ProsesPremiFakultatifMasuk/GeneratePstRateAOG?kd_jns_kend=${$("#kd_jns_kend").val()}&kd_wilayah=${$("#kd_wilayah").val()}&kd_jns_ptg=${$("#kd_jns_ptg").val()}&nilai_casco=${$("#nilai_casco").val()}&flag_aog=${!e.checked}`, (returnValue) => {
...
function OnPstRateAOGChange(e){
    var value = e.sender.value();
    ajaxGet(`/ProsesPremiFakultatifMasuk/GenerateNilaiPrmAOG?nilai_casco=${$("#nilai_casco").val()}&pst_rate_aog=${value}&stn_rate_aog=${$("#stn_rate_aog").val()}`, (returnValue) => {
        $("#nilai_prm_aog").getKendoNumericTextBox().value(returnValue.split(",")[1]);
    });
}

function OnBanjirChange(e){
    ajaxGet(`/ProsesPremiFakultatifMasuk/GeneratePstRateBanjir?kd_jns_kend=${$("#kd_jns_kend").val()}&kd_wilayah=${$("#kd_wilayah").val()}&kd_jns_ptg=${$("#kd_jns_ptg").val()}&nilai_casco=${$("#nilai_casco").val()}&flag_banjir=${!e.checked}`, (returnValue) => {
...
function OnPstRateBanjirChange(e){
    var value = e.sender.value();
    ajaxGet(`/ProsesPremiFakultatifMasuk/GenerateNilaiPrmBanjir?nilai_casco=${$("#nilai_casco").val()}&pst_rate_banjir=${value}&stn_rate_banjir=${$("#stn_rate_banjir").val()}`, (returnValue) => {
        $("#nilai_prm_banjir").getKendoNumericTextBox().value(returnValue.split(",")[1]);
    });
}

function OnTRSChange(e){
    ajaxGet(`/ProsesPremiFakultatifMasuk/GeneratePstRateTRS?kd_jns_kend=${$("#kd_jns_kend").val()}&kd_wilayah=${$("#kd_wilayah").val()}&kd_jns_ptg=${$("#kd_jns_ptg").val()}&nilai_casco=${$("#nilai_casco").val()}&flag_trs=${!e.checked}`, (returnValue) => {
...
function OnPstRateTRSChange(e){
    var value = e.sender.value();
    ajaxGet(`/ProsesPremiFakultatifMasuk/GenerateNilaiPrmTRS?nilai_casco=${$("#nilai_casco").val()}&pst_rate_trs=${value}&stn_rate_trs=${$("#stn_rate_trs").val()}`, (returnValue) => {
        $("#nilai_prm_trs").getKendoNumericTextBox().value(returnValue.split(",")[1]);
    });
}

function OnNilaiTJHChange(e){
    ajaxGet(`/ProsesPremiFakultatifMasuk/GenerateNilaiPrmAndPstRateTJHKend?kd_jns_kend=${$("#kd_jns_kend").val()}&kd_wilayah=${$("#kd_wilayah").val()}&kd_jns_ptg=${$("#kd_jns_ptg").val()}&nilai_tjh=${e.sender.value()}`, (returnValue) => {
...
function OnNilaiTJPChange(e){
    ajaxGet(`/ProsesPremiFakultatifMasuk/GenerateNilaiPrmAndPstRateTJP?kd_jns_kend=${$("#kd_jns_kend").val()}&kd_wilayah=${$("#kd_wilayah").val()}&kd_jns_ptg=${$("#kd_jns_ptg").val()}&nilai_tjp=${e.sender.value()}`, (returnValue) => {
...
function OnPAPChange(e){
    ajaxGet(`/ProsesPremiFakultatifMasuk/GeneratePstRatePAP?kd_jns_kend=${$("#kd_jns_kend").val()}&kd_wilayah=${$("#kd_wilayah").val()}&kd_jns_ptg=${$("#kd_jns_ptg").val()}&nilai_pap=${$("#nilai_pap").val()}`, (returnValue) => {
...
function OnPstRatePAPChange(e){
    var value = e.sender.value();
    ajaxGet(`/ProsesPremiFakultatifMasuk/GenerateNilaiPrmPAP?nilai_pap=${$("#nilai_pap").val()}&pst_rate_pap=${value}&stn_rate_pap=${$("#stn_rate_pap").val()}&jml_pap=${$("#jml_pap").val()}`, (returnValue) => {
        $("#nilai_prm_pap").getKendoNumericTextBox().value(returnValue.split(",")[1]);
    });
}

function OnPADChange(e){
    ajaxGet(`/ProsesPremiFakultatifMasuk/GeneratePstRatePAD?kd_jns_kend=${$("#kd_jns_kend").val()}&kd_wilayah=${$("#kd_wilayah").val()}&kd_jns_ptg=${$("#kd_jns_ptg").val()}&nilai_pad=${$("#nilai_pad").val()}`, (returnValue) => {
...
function OnPstRatePADChange(e){
    var value = e.sender.value();
    ajaxGet(`/ProsesPremiFakultatifMasuk/GenerateNilaiPrmPAD?nilai_pad=${$("#nilai_pad").val()}&pst_rate_pad=${value}&stn_rate_pad=${$("#stn_rate_pad").val()}`, (returnValue) => {
