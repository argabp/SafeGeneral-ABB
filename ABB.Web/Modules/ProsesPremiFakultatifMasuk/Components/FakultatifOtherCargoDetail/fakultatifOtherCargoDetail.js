...
function btnAddAkseptasiOtherCargoDetail_Click() {
    $('#btnAddNewAkseptasiOtherCargoDetail').click(function () {
        openAkseptasiOtherCargoDetailWindow(`/ProsesPremiFakultatifMasuk/AddOtherCargoDetail?kd_cb=${$("#kd_cb").val()}&kd_cob=${$("#kd_cob").val()}&kd_scob=${$("#kd_scob").val()}&kd_thn=${$("#kd_thn").val()}&no_aks=${$("#no_aks").val()}&no_updt=${$("#no_updt").val()}`, 'Add New Alat Angkut');
    });
}
...
function btnEditAkseptasiOtherCargoDetail_OnClick(e) {
    ...
    openAkseptasiOtherCargoDetailWindow(`/ProsesPremiFakultatifMasuk/EditOtherCargoDetail?kd_cb=${dataItem.kd_cb}&kd_cob=${dataItem.kd_cob}&kd_scob=${dataItem.kd_scob}&kd_thn=${dataItem.kd_thn}&no_aks=${dataItem.no_aks}&no_updt=${dataItem.no_updt}&no_rsk=${dataItem.no_rsk}&kd_endt=${dataItem.kd_endt}&no_urut=${dataItem.no_urut}`, 'Edit Other Alat Angkut');
}
...
function deleteAkseptasiOtherCargoDetail(dataItem) {
    ajaxGet(`/ProsesPremiFakultatifMasuk/DeleteOtherCargoDetail?kd_cb=${dataItem.kd_cb}&kd_cob=${dataItem.kd_cob}&kd_scob=${dataItem.kd_scob}&kd_thn=${dataItem.kd_thn}&no_aks=${dataItem.no_aks}&no_updt=${dataItem.no_updt}&no_rsk=${dataItem.no_rsk}&kd_endt=${dataItem.kd_endt}&no_urut=${dataItem.no_urut}`, function (response) {
        if (response.Result) {
