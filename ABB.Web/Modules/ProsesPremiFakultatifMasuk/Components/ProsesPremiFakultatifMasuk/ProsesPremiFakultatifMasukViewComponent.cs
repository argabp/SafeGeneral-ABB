...
namespace ABB.Web.Modules.ProsesPremiFakultatifMasuk.Components.ProsesPremiFakultatifMasuk
{
    public class ProsesPremiFakultatifMasukViewComponent : ViewComponent
    {
        private readonly IMediator _mediator;
        private readonly IMapper _mapper;

        public ProsesPremiFakultatifMasukViewComponent(IMediator mediator, IMapper mapper)
        {
            _mediator = mediator;
            _mapper = mapper;
        }
        ...
        public async Task<IViewComponentResult> InvokeAsync(AkseptasiParameterViewModel model)
        {
            ...
            if (model == null) return View("_ProsesPremiFakultatifMasuk", akseptasiViewModel);
            ...
            if (result == null)
            {
                ...
                return View("_ProsesPremiFakultatifMasuk", akseptasiViewModel);
            }
