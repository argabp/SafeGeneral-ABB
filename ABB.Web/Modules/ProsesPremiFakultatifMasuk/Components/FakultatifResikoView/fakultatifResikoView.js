...
function onSelect(e) {
    ...
    if(tabName == "Alokasi")
    {
        ...
        ajaxPost(`/ProsesPremiFakultatifMasuk/ProsesAlokasi`, JSON.stringify(data),
            function (response) {
    ...
    else if(tabName == "Coverage")
    {
        ...
        ajaxGet(`/ProsesPremiFakultatifMasuk/CheckCoverage?kd_cob=${$("#kd_cob").val()}&kd_scob=${$("#kd_scob").val()}`,
            function (response) {
    ...
    else if(tabName == "Obyek")
    {
        ...
        ajaxGet(`/ProsesPremiFakultatifMasuk/CheckObyek?kd_cob=${$("#kd_cob").val()}&kd_scob=${$("#kd_scob").val()}&pst_share=${resiko.pst_share_bgu}`,
            function (response) {
