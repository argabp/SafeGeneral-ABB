...
function btnEditAkseptasiCoverage_OnClick(e) {
    ...
    openAkseptasiCoverageWindow(`/ProsesPremiFakultatifMasuk/EditCoverage?kd_cb=${dataItem.kd_cb}&kd_cob=${dataItem.kd_cob}&kd_scob=${dataItem.kd_scob}&kd_thn=${dataItem.kd_thn}&no_aks=${dataItem.no_aks}&no_updt=${dataItem.no_updt}&no_rsk=${dataItem.no_rsk}&kd_endt=${dataItem.kd_endt}&kd_cvrg=${encodeURIComponent(dataItem.kd_cvrg)}`, 'Edit Coverage');
}
...
function deleteAkseptasiCoverage(dataItem) {
    ajaxGet(`/ProsesPremiFakultatifMasuk/DeleteCoverage?kd_cb=${dataItem.kd_cb}&kd_cob=${dataItem.kd_cob}&kd_scob=${dataItem.kd_scob}&kd_thn=${dataItem.kd_thn}&no_aks=${dataItem.no_aks}&no_updt=${dataItem.no_updt}&no_rsk=${dataItem.no_rsk}&kd_endt=${dataItem.kd_endt}&kd_cvrg=${dataItem.kd_cvrg}`, function (response) {
        if (response.Result) {
