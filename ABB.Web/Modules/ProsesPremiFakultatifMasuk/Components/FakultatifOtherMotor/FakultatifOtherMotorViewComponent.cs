...
namespace ABB.Web.Modules.ProsesPremiFakultatifMasuk.Components.FakultatifOtherMotor
{
    public class FakultatifOtherMotorViewComponent : ViewComponent
    {
        private readonly IMediator _mediator;
        private readonly IMapper _mapper;

        public FakultatifOtherMotorViewComponent(IMediator mediator, IMapper mapper)
        {
            _mediator = mediator;
            _mapper = mapper;
        }
        ...
        public async Task<IViewComponentResult> InvokeAsync(AkseptasiResikoParameterViewModel model)
        {
            ...
            if (motorResult == null)
            {
                ...
                return View("_FakultatifOtherMotor", akseptasiMotorViewModel);
            }
