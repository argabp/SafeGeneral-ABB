...
namespace ABB.Web.Modules.ProsesPremiFakultatifMasuk.Components.FakultatifOtherCargo
{
    public class FakultatifOtherCargoViewComponent : ViewComponent
    {
        private readonly IMediator _mediator;
        private readonly IMapper _mapper;

        public FakultatifOtherCargoViewComponent(IMediator mediator, IMapper mapper)
        {
            _mediator = mediator;
            _mapper = mapper;
        }
        ...
        public async Task<IViewComponentResult> InvokeAsync(AkseptasiResikoParameterViewModel model)
        {
            ...
            if (cargoResult == null)
            {
                ...
                return View("_FakultatifOtherCargo", akseptasiCargoViewModel);
            }
