...
function btnAddAkseptasiPranotaKoas_Click() {
    $('#btnAddNewAkseptasiPranotaKoas').click(function () {
        openAkseptasiPranotaKoasWindow(`/ProsesPremiFakultatifMasuk/AddPranotaKoas?kd_cb=${$("#kd_cb").val()}&kd_cob=${$("#kd_cob").val()}&kd_scob=${$("#kd_scob").val()}&kd_thn=${$("#kd_thn").val()}&no_aks=${$("#no_aks").val()}&no_updt=${$("#no_updt").val()}&kd_mtu=${$("#kd_mtu").val()}`, 'Add New Koasuransi Member');
    });
}
...
function btnEditAkseptasiPranotaKoas_OnClick(e) {
    ...
    openAkseptasiPranotaKoasWindow(`/ProsesPremiFakultatifMasuk/EditPranotaKoas?kd_cb=${dataItem.kd_cb}&kd_cob=${dataItem.kd_cob}&kd_scob=${dataItem.kd_scob}&kd_thn=${dataItem.kd_thn}&no_aks=${dataItem.no_aks}&no_updt=${dataItem.no_updt}&kd_mtu=${dataItem.kd_mtu}&kd_grp_pas=${dataItem.kd_grp_pas}&kd_rk_pas=${dataItem.kd_rk_pas}`, 'Edit Koasuransi Member');
}
...
function deleteAkseptasiPranotaKoas(dataItem) {
    ajaxGet(`/ProsesPremiFakultatifMasuk/DeletePranotaKoas?kd_cb=${dataItem.kd_cb}&kd_cob=${dataItem.kd_cob}&kd_scob=${dataItem.kd_scob}&kd_thn=${dataItem.kd_thn}&no_aks=${dataItem.no_aks}&no_updt=${dataItem.no_updt}&kd_mtu=${dataItem.kd_mtu}&kd_grp_pas=${dataItem.kd_grp_pas}&kd_rk_pas=${dataItem.kd_rk_pas}`, function (response) {
        if (response.Result) {
