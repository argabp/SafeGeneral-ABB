...
namespace ABB.Web.Modules.ProsesPremiFakultatifMasuk
{
    //NOTE: Using same BE as Akseptasi just modify on controller
    public class ProsesPremiFakultatifMasukController : AuthorizedBaseController
    {
        ...
        public async Task<IActionResult> CheckCoverage(string kd_cob, string kd_scob)
        {
            ...
            {
                return PartialView("EmptyWithMessage", result.Item2);
            }
            else
            {
                return PartialView("~/Modules/ProsesPremiFakultatifMasuk/Components/FakultatifCoverage/_FakultatifCoverage.cshtml", new AkseptasiResikoCoverageViewModel());
            }
        }
            ...
            switch (Constant.AkseptasiObyekViewMapping[resultView])
            {
                ...
                case "_ObyekFireFull":
                    return PartialView("~/Modules/Akseptasi/Views/EditObyekFireFull.cshtml",
                        model);
                default:
                    return PartialView("EmptyWithMessage");
            }
        }
        ...
        public async Task<IActionResult> CheckObyek(string kd_cob, string kd_scob, decimal? pst_share)
        {
            ...
            {
                case "_ObyekFire":
                    return View("~/Modules/ProsesPremiFakultatifMasuk/Components/FakultatifObyek/_FakultatifObyekFire.cshtml",
                        new AkseptasiResikoObyekViewModel());
                case "_ObyekFireFull":
                    return View("~/Modules/ProsesPremiFakultatifMasuk/Components/FakultatifObyek/_FakultatifObyekFireFull.cshtml",
                        new AkseptasiResikoObyekViewModel());
                case "_ObyekCIS":
                    return View("~/Modules/ProsesPremiFakultatifMasuk/Components/FakultatifObyek/_FakultatifObyekCIS.cshtml",
                        new AkseptasiResikoObyekCISViewModel());
                case "_ObyekCIT":
                    return View("~/Modules/ProsesPremiFakultatifMasuk/Components/FakultatifObyek/_FakultatifObyekCIT.cshtml",
            ...
            switch (model.kd_cob.Trim())
            {
                case "B":
                    ...
                    if (bondingResult == null)
                    {
                        ...
                        return PartialView("~/Modules/ProsesPremiFakultatifMasuk/Components/FakultatifOther/_FakultatifOtherBonding.cshtml", akseptasiBondingViewModel);
                    }
                    ...
                    return PartialView("~/Modules/ProsesPremiFakultatifMasuk/Components/FakultatifOther/_FakultatifOtherBonding.cshtml", akseptasiBondingViewModel);
                case "C":
                    return PartialView("~/Modules/ProsesPremiFakultatifMasuk/Components/FakultatifOther/_FakultatifOtherCargo.cshtml" , model);
                case "M":var akseptasiMotorViewModel = new AkseptasiResikoOtherMotorViewModel()
                    ...
                    if (motorResult == null)
                    {
                        ...
                        return View("~/Modules/ProsesPremiFakultatifMasuk/Components/FakultatifOther/_FakultatifOtherMotor.cshtml", akseptasiMotorViewModel);
                    }
                ...
                case "F":
                    ...
                    if (fireResult == null)
                    {
                        ...
                        return PartialView("~/Modules/ProsesPremiFakultatifMasuk/Components/FakultatifOther/_FakultatifOtherFire.cshtml", akseptasiFireViewModel);
                    }
                ...
                case "H":
                    ...
                    if (hullResult == null)
                    {
                        return PartialView("~/Modules/ProsesPremiFakultatifMasuk/Components/FakultatifOther/_FakultatifOtherHull.cshtml", akseptasiHullViewModel);
                    }
                ...
                case "P":
                    ...
                    if (paResult == null)
                    {
                        ...
                        return PartialView("~/Modules/ProsesPremiFakultatifMasuk/Components/FakultatifOther/_FakultatifOtherPA.cshtml", akseptasiPaViewModel);
                    }
                ...
                case "V":
                    ...
                    {
                        return PartialView("~/Modules/ProsesPremiFakultatifMasuk/Components/FakultatifOther/_FakultatifOtherHoleInOne.cshtml", akseptasiHoleInOneViewModel);
                    }
            ...
            switch (Constant.AkseptasiOtherViewMapping[resultView])
            {
                case "_OtherBonding":
                    ...
                    if (bondingResult == null)
                    {
                        ...
                        return View("~/Modules/ProsesPremiFakultatifMasuk/Components/FakultatifOther/_FakultatifOtherBonding.cshtml", akseptasiBondingViewModel);
                    }
                    ...
                    return View("~/Modules/ProsesPremiFakultatifMasuk/Components/FakultatifOther/_FakultatifOtherBonding.cshtml", akseptasiBondingViewModel);
                case "_OtherCargo":
                    return View("~/Modules/ProsesPremiFakultatifMasuk/Components/FakultatifOther/_FakultatifOtherCargo.cshtml", model);
                case "_OtherMotor":
                ...
                case "_OtherFire":
                    ...
                    if (fireResult == null)
                    {
                        ...
                        return View("~/Modules/ProsesPremiFakultatifMasuk/Components/FakultatifOther/_FakultatifOtherFire.cshtml", akseptasiFireViewModel);
                    }
                ...
                case "_OtherHull":
                    ...
                    if (hullResult == null)
                    {
                        ...
                        return View("~/Modules/ProsesPremiFakultatifMasuk/Components/FakultatifOther/_FakultatifOtherHull.cshtml", akseptasiHullViewModel);
                    }
                ...
                case "_OtherPA":
                    ...
                    if (paResult == null)
                    {
                        ...
                        return View("~/Modules/ProsesPremiFakultatifMasuk/Components/FakultatifOther/_FakultatifOtherPA.cshtml", akseptasiPaViewModel);
                    }
        ...
        public async Task<IActionResult> SaveAkseptasiPranota([FromBody] AkseptasiPranotaViewModel model)
        {
            ...
            return PartialView("~/Modules/ProsesPremiFakultatifMasuk/Components/FakultatifPranota/_FakultatifPranota.cshtml");
        }
            ...
            string kd_scob, string kd_thn, string no_aks, short no_updt)
        {
            ...
            return View("~/Modules/ProsesPremiFakultatifMasuk/Components/FakultatifPranotaKoas/_FakultatifPranotaKoas.cshtml", new AkseptasiPranotaKoasViewModel());
        }
