...
function btnSaveAkseptasiOtherCargoDetail_Click() {
    $('#btn-save-akseptasiOtherCargoDetail').click(function () {
        ...
        setTimeout(function () {
            saveAkseptasiOtherCargoDetail('/ProsesPremiFakultatifMasuk/SaveAkseptasiOtherCargoDetail')
        }, 500);
    });
}
...
function OnKodeKapalChange(e){
    ajaxGet(`/ProsesPremiFakultatifMasuk/GenerateNamaAngkut?kd_angkut=${e.sender._cascadedValue}`, (returnValue) => {
