...
function searchKeyword_OnKeyUp() {
    $('#SearchKeyword').keyup(function () {
        refreshGrid("#CancelPostingNotaTreatyMasukXOLGrid");
    });
}

function searchFilterCancelPostingNotaTreatyMasukXOL(e) {
...
function onChangeGridCancelPostingNotaTreatyMasukXOL(e) {
    var grid = e.sender;
...
function cancelPostingNotaTreatyMasukXOL(){
    showConfirmation('Confirmation', `Are you sure you want to cancel?`,
        function () {
            showProgressOnGrid('#CancelPostingNotaTreatyMasukXOLGrid');

            ajaxPost("/CancelPostingNotaTreatyMasukXOL/Cancel", JSON.stringify(selectedRowsData),
                function (response) {
                    ...
                    var grid = $("#CancelPostingNotaTreatyMasukXOLGrid").data("kendoGrid");
                    if (grid) {
                        grid.clearSelection();
                    }
                    selectedRowsData = [];
                    refreshGrid('#CancelPostingNotaTreatyMasukXOLGrid');
                    closeProgressOnGrid('#CancelPostingNotaTreatyMasukXOLGrid');
                },
            );
        }
    );
