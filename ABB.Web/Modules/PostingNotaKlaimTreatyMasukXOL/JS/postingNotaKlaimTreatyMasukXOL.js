...
function searchKeyword_OnKeyUp() {
    $('#SearchKeyword').keyup(function () {
        refreshGrid("#PostingNotaKlaimTreatyMasukXOLGrid");
    });
}

function searchFilterPostingNotaKlaimTreatyMasukXOL(e) {
...
function onChangeGridPostingNotaKlaimTreatyMasukXOL(e) {
    var grid = e.sender;
...
function postingNotaKlaimTreatyMasukXOL(){
    showConfirmation('Confirmation', `Are you sure you want to posting?`,
        function () {
            showProgressOnGrid('#PostingNotaKlaimTreatyMasukXOLGrid');

            ajaxPost("/PostingNotaKlaimTreatyMasukXOL/Posting", JSON.stringify(selectedRowsData),
                function (response) {
                    ...
                    var grid = $("#PostingNotaKlaimTreatyMasukXOLGrid").data("kendoGrid");
                    if (grid) {
                        grid.clearSelection();
                    }
                    selectedRowsData = [];
                    refreshGrid('#PostingNotaKlaimTreatyMasukXOLGrid');
                    closeProgressOnGrid('#PostingNotaKlaimTreatyMasukXOLGrid');
                },
            );
        }
    );
