...
namespace ABB.Web.Modules.InquiryPremiFakultatifMasuk.Components.InquiryFakultatifOtherMotor
{
    public class InquiryFakultatifOtherMotorViewComponent : ViewComponent
    {
        private readonly IMediator _mediator;
        private readonly IMapper _mapper;

        public InquiryFakultatifOtherMotorViewComponent(IMediator mediator, IMapper mapper)
        {
            _mediator = mediator;
            _mapper = mapper;
        }
        ...
        {
            var akseptasiMotorViewModel = new InquiryResikoOtherMotorViewModel()
            {
            ...
            if (motorResult == null)
            {
                ...
                return View("_InquiryFakultatifOtherMotor", akseptasiMotorViewModel);
            }
