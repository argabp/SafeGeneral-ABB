...
function btnViewAkseptasiResiko_OnClick(e) {
    e.preventDefault();
    var dataItem = this.dataItem($(e.currentTarget).closest("tr"));
    console.log('dataItem', dataItem);
    openAkseptasiResikoWindow(`/InquiryPremiFakultatifMasuk/ViewResiko?kd_cb=${dataItem.kd_cb}&kd_cob=${dataItem.kd_cob}&kd_scob=${dataItem.kd_scob}&kd_thn=${dataItem.kd_thn}&no_pol=${dataItem.no_pol}&no_updt=${dataItem.no_updt}&no_rsk=${dataItem.no_rsk}&kd_endt=${dataItem.kd_endt}`, 'View Resiko');
}
...
function refreshTabOther(){
    ...
    ajaxPost("/InquiryPremiFakultatifMasuk/GetResikoOther", data,
        function (response) {
