...
function btnViewAkseptasiOtherMotorDetail_OnClick(e) {
    e.preventDefault();
    var dataItem = this.dataItem($(e.currentTarget).closest("tr"));
    console.log('dataItem', dataItem);
    openAkseptasiOtherMotorDetailWindow(`/InquiryPremiFakultatifMasuk/ViewOtherMotorDetail?kd_cb=${dataItem.kd_cb}&kd_cob=${dataItem.kd_cob}&kd_scob=${dataItem.kd_scob}&kd_thn=${dataItem.kd_thn}&no_pol=${dataItem.no_pol}&no_updt=${dataItem.no_updt}&no_rsk=${dataItem.no_rsk}&kd_endt=${dataItem.kd_endt}&thn_ptg_kend=${dataItem.thn_ptg_kend}`, 'View Other Motor Detail');
}
