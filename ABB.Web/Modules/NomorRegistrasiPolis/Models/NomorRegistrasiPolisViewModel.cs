...
namespace ABB.Web.Modules.NomorRegistrasiPolis.Models
{
    public class NomorRegistrasiPolisViewModel : IMapFrom<Domain.Entities.NomorRegistrasiPolis>
    {
        ...
        {
            profile.CreateMap<Domain.Entities.NomorRegistrasiPolis, NomorRegistrasiPolisViewModel>();
            profile.CreateMap<NomorRegistrasiPolisViewModel, SaveNomorRegistrasiPolisCommand>();
        }
    }
}