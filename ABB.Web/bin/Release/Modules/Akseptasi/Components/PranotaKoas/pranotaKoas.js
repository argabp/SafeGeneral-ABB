...
function btnEditAkseptasiPranotaKoas_OnClick(e) {
    ...
    openAkseptasiPranotaKoasWindow(`/Akseptasi/EditPranotaKoas?kd_cb=${dataItem.kd_cb}&kd_cob=${dataItem.kd_cob}
...
function deleteAkseptasiPranotaKoas(dataItem) {
    ajaxGet(`/Akseptasi/DeletePranotaKoas?kd_cb=${dataItem.kd_cb}&kd_cob=${dataItem.kd_cob}
                &kd_scob=${dataItem.kd_scob}&kd_thn=${dataItem.kd_thn}&no_aks=${dataItem.no_aks}
                &no_updt=${dataItem.no_updt}&kd_mtu=${dataItem.kd_mtu}&kd_grp_pas=${dataItem.kd_grp_pas}
                &kd_rk_pas=${dataItem.kd_rk_pas}`, function (response) {
        if (response.Result) {
