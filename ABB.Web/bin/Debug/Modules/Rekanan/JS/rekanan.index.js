...
function onDeleteRekanan(e){
    ...
    showConfirmation('Confirmation', `Are you sure you want to delete?`,
        function () {
            ...
            ajaxPost("/Rekanan/DeleteRekanan", JSON.stringify(data),
                function (response) {
                    if (response.Result == "OK") {
                        showMessage('Success', response.Message);
                    } else
...
function onSaveDetailRekananIndividu(){
    var url = "/Rekanan/SaveDetailRekanan";
...
function onDeleteDetailRekanan(e){
    ...
    showConfirmation('Confirmation', `Are you sure you want to delete?`,
        function () {
            ...
            ajaxPost("/Rekanan/DeleteDetailRekanan", JSON.stringify(data),
                function (response) {
                    if (response.Result == "OK") {
                        showMessage('Success', response.Message);
                    } else
...
function btnAddRekanan_OnClick() {
    openWindow('#RekananWindow', `/Rekanan/AddRekananView`, 'Add');
}
...
function btnEditRekanan_OnClick(e) {
    ...
    openWindow('#RekananWindow', `/Rekanan/EditRekananView?kd_cb=${dataItem.kd_cb.trim()}&kd_grp_rk=${dataItem.kd_grp_rk}&kd_rk=${dataItem.kd_rk}`, 'Edit');
}
...
function btnEditDetailRekanan_OnClick(e) {
    ...
    console.log('dataItem', dataItem);
    openWindow('#DetailRekananWindow', `/Rekanan/EditDetailRekananView?kd_cb=${dataItem.kd_cb.trim()}&kd_grp_rk=${dataItem.kd_grp_rk}&kd_rk=${dataItem.kd_rk}&flag_sic=${dataItem.flag_sic}`, 'Edit');
}